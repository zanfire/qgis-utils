...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 381, 472))
        ...
        self.typologyEdit = QtGui.QLineEdit(self.verticalLayoutWidget)
        self.typologyEdit.setObjectName(_fromUtf8("typologyEdit"))
        self.verticalLayout.addWidget(self.typologyEdit)
        self.typologyOpenButton = QtGui.QPushButton(self.verticalLayoutWidget)
        self.typologyOpenButton.setObjectName(_fromUtf8("typologyOpenButton"))
        self.verticalLayout.addWidget(self.typologyOpenButton)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_7.setText(_translate("Dialog", "Typology CSV file:", None))
        self.typologyOpenButton.setText(_translate("Dialog", "Select file", None))
