...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.keepTemporaryLayerCheckBox = QtGui.QCheckBox(self.verticalLayoutWidget)
        self.keepTemporaryLayerCheckBox.setChecked(False)
        self.keepTemporaryLayerCheckBox.setObjectName(_fromUtf8("keepTemporaryLayerCheckBox"))
        self.verticalLayout.addWidget(self.keepTemporaryLayerCheckBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.keepTemporaryLayerCheckBox.setText(_translate("Dialog", "Keep temporary layer (debug)", None))
