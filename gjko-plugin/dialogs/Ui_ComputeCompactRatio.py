...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.locationButton_2 = QtGui.QPushButton(self.verticalLayoutWidget)
        self.locationButton_2.setEnabled(True)
        self.locationButton_2.setObjectName(_fromUtf8("locationButton_2"))
        self.verticalLayout.addWidget(self.locationButton_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.locationButton_2.setText(_translate("Dialog", "Location", None))
