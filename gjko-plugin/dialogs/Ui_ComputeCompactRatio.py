...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.landregisterCombo = QtGui.QComboBox(self.verticalLayoutWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.landregisterCombo.sizePolicy().hasHeightForWidth())
        self.landregisterCombo.setSizePolicy(sizePolicy)
        self.landregisterCombo.setSizeAdjustPolicy(QtGui.QComboBox.AdjustToContentsOnFirstShow)
        self.landregisterCombo.setObjectName(_fromUtf8("landregisterCombo"))
        self.verticalLayout.addWidget(self.landregisterCombo)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Cartograpy layer:", None))
